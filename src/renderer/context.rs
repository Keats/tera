...
impl<'a> Context<'a> {
  ...
  ///
  #[inline]
  pub fn find_value(self: & Self,
      key: & str) -> Option<& 'a Value> {
  ...
  ///
  #[inline]
  pub fn find_value_by_pointer(self: & Self,
      pointer: & str) -> Option<& 'a Value> {
...
use super::*;
mod context {
        // custom <module context ModuleTop>
        ...
        // end <module context ModuleTop>

use super::*;

    #[test]
    fn find_value() -> () {
            // custom <test fn context_find_value>
            ...
            // end <test fn context_find_value>
    }

    #[test]
    fn find_value_by_pointer() -> () {
            // custom <test fn context_find_value_by_pointer>
            ...
            // end <test fn context_find_value_by_pointer>
    }
}
}
